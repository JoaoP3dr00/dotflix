...
public class VideoValidatorTest{
    @Test
    public void validateNullTitleTest() throws Exception {
        // Arrange
        ...
        final String expectedErrorMessage = "'title' should not be null";

        // Act
        final Exception actualError = Assertions.assertThrows(
                Exception.class,
                () -> Video.newVideo(
                        expectedTitle,
                        expectedDescription,
    ...
    @Test
    public void validateEmptyTitleTest() throws Exception {
        // Arrange
        ...
        final String expectedErrorMessage = "'title' should not be empty";
    ...
    @Test
    public void validateTitleLenghtTest() throws Exception {
        // Arrange
        final String expectedTitle = """
                Disclaimer: o estudo de caso apresentado tem fins educacionais e representa nossas opiniões pessoais.
                Esse vídeo faz parte da Imersão Full Stack && Full Cycle.
        ...
        final String expectedErrorMessage = "'title' must be between 1 and 255 characters";
    ...
    @Test
    public void validateEmptyDescriptionTest() throws Exception {
        // Arrange
        ...
        final String expectedErrorMessage = "'description' should not be empty";
    ...
    @Test
    public void validateDescriptionLengthTest() throws Exception {
        // Arrange
        final String expectedTitle = "System Design Interviews";
        final String expectedDescription = """
        ...
        final String expectedErrorMessage = "'description' must be between 1 and 4000 characters";
    ...
    @Test
    public void validateNullLaunchedAtTest() throws Exception {
        // Arrange
        final String expectedTitle = "System Design Interviews";
        ...
        final String expectedErrorMessage = "'launchedAt' should not be null";
    ...
    @Test
    public void validateNullRatingTest() throws Exception {
        // Arrange
        final String expectedTitle = "System Design Interviews";
        final String expectedDescription = "A description";
        final Year expectedLaunchedAt = Year.of(2022);
